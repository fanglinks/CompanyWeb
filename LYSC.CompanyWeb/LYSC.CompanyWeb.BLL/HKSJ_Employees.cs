...
namespace LYSC.CompanyWeb.BLL
{
	...
	{
		private readonly LYSC.CompanyWeb.DAL.HKSJ_Employees dal=new LYSC.CompanyWeb.DAL.HKSJ_Employees();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LYSC.CompanyWeb.Model.HKSJ_Employees GetModelByCache(int ID)
		{
			...
			return (LYSC.CompanyWeb.Model.HKSJ_Employees)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LYSC.CompanyWeb.Model.HKSJ_Employees> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LYSC.CompanyWeb.Model.HKSJ_Employees> DataTableToList(DataTable dt)
		{
			List<LYSC.CompanyWeb.Model.HKSJ_Employees> modelList = new List<LYSC.CompanyWeb.Model.HKSJ_Employees>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LYSC.CompanyWeb.Model.HKSJ_Employees model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new LYSC.CompanyWeb.Model.HKSJ_Employees();
